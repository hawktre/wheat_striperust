#!/bin/bash
#SBATCH -J Sensitivity               # Job name
#SBATCH -o DataProcessed/results/backward_model/logs/backward_fit_sensitivity_%A_%a.out     # Stdout log (%A=job ID, %a=array index)
#SBATCH -e DataProcessed/results/backward_model/logs/backward_fit_sensitivity_%A_%a.err     # Stderr log
...
Rscript --vanilla Code/R/backward_model_sensitivity/BackwardModelFit_Sensitivity.R
