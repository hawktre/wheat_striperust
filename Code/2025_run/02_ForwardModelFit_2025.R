## ---------------------------
##
## Script name: 02_ForwardModelFit_2025.R
##
## Purpose of script: Fit forward model
##
...
saveRDS(free_fits, here("DataProcessed/results/forward_model/forward_fits_2025.rds"))
