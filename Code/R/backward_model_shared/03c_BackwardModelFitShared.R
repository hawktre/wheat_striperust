...
saveRDS(backward_result, file.path(output_dir, paste0("backward_blk", combo$blk,"_trt",combo$trt,"_vst",combo$vst,"_config", combo$config, "_nsrc", combo$n_src, "_shared.rds")))
