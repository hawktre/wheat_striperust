...
# Run after Code/R/source_detection/run_main_analysis.R has completed.
...
result_directory <- here("DataProcessed", "results", "source_detection_main")
...
spatial_grids <- readRDS(here(
  "DataProcessed", "experimental", "grids_sp.rds"
))
