...
`SOURCE_DETECTION_CORES=4 Rscript Code/R/source_detection/run_main_analysis.R`.
...
diagnostic figures under `DataProcessed/results/source_detection_main/plots`.
...
are written to
`DataProcessed/results/source_detection_initialization_sensitivity`. When the
