...
library(here)
library(sf)
source(here("src/data_prep/00c_DataFormat_Fun.R"))

# Read in the data --------------------------------------------------------
stripe <- readRDS(here("data/processed/experimental/stripe_clean.rds"))
wind <- readRDS(here("data/processed/wind/wind_clean.rds"))
...
saveRDS(grids, here("data/processed/experimental/grids_sp.rds"))
...
saveRDS(mod_dat, here("data/processed/experimental/mod_dat_arrays.rds"))
