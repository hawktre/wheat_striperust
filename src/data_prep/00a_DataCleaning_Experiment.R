...
## Experimental Data
for (sheet in blocks) {
  stripe[[sheet]] <- read_xlsx(here("data/raw/StripeRust.xlsx"), sheet = sheet)
}
...
## inoculum Locations
inoculum <- read_xlsx(here("data/raw/StripeRust.xlsx"), sheet = "inoculum")
...
saveRDS(inoc_sp, here("data/processed/experimental/inoc_sp.rds"))
...
saveRDS(stripe_clean, here("data/processed/experimental/stripe_clean.rds"))
