...
source(here("src", "simulation", "whole_epidemic_pilot_functions.R"))
...
output_directory <- here(
  "output", "simulation", "whole_epidemic_pilot"
)
...
source(here("src", "simulation", "plot_whole_epidemic_pilot.R"))
